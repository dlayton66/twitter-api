...
//	    // ----- TWEETS -----
        ...
        tweet1.setMentions(new HashSet<>(Arrays.asList(user1, user2)));
        ...
        tweet5.setMentions(new HashSet<>(Arrays.asList(user1, user2)));
        ...
        tweet6.setMentions(new HashSet<>(Arrays.asList(user1, user2)));
        ...
        deletedTweet.setMentions(new HashSet<>(Arrays.asList(user1, user2)));
        tweetRepository.saveAndFlush(deletedTweet);

        // ----- SET of Tweets + Adding to User# -----
        Set<Tweet> user1Tweets = Set.of(tweet1, tweet2);
        user1.setTweets(user1Tweets);
        userRepository.saveAndFlush(user1);

        Set<Tweet> user2Tweets = Set.of(tweet3, tweet4);
        user2.setTweets(user2Tweets);
        userRepository.saveAndFlush(user2);

        Set<Tweet> user3Tweets = Set.of(tweet5, tweet6);
        ...
        userRepository.saveAndFlush(user1);
        // ----- Set of Followers -----
        Set<User> followersSet = Set.of(user3, user5);
        user1.setFollowers(followersSet);
        userRepository.saveAndFlush(user1);
        ...
        // Following
        Set<User> following_1 = Set.of(user2, user3, user4, deletedUser);
